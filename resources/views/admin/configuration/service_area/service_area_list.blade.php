    ...
    <div class="row">
        <div class="col-md-12 col-xs-12 col-sm-12" style="margin-top:50px;">
            <div class="x_panel">
                ...
                <div class="x_title">
                    <h2 style="float: left">Service Area List</h2>
                    <a href="{{route('admin.add_service_area_form')}}" class="btn btn-warning" style="float: right">Add New</a>
     ...
     <script type="text/javascript">
         $(function () {
            ...
            var table = $('#product_list').DataTable({
                ...
                serverSide: true,
                iDisplayLength: 50,
                ajax: "{{route('admin.serviceArea_list_ajax')}}",
                columns: [
